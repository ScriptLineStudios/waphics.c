...
Module['FS_createPath']("/assets", "images", true, true);
    ...
    loadPackage({"files": [{"filename": "/assets/images/block1.png", "start": 0, "end": 247}], "remote_package_size": 247, "package_uuid": "16990ca1-78ee-455c-a5e8-0ccd2fe23d94"});
...
function get_key(code){ return Module[code] == 1; }
